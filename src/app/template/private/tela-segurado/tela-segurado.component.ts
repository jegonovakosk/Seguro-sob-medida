...
@Component({
  selector: 'app-tela-segurado',
  templateUrl: './tela-segurado.component.html',
  styleUrls: ['./tela-segurado.component.scss']
})
export class TelaSeguradoComponent implements OnInit {
